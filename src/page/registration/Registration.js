            ...
            <div>
                ...
                <Form onFinish={handleSubmit(onSubmit)} className='w-[325px] mx-auto gap-y-[21px] flex flex-col'>
                    ...
                    <div className='mx-auto mt-[43px] mb-[21px]'>
                        <button htmlType="submit" className='flex justify-center items-center bg-gradient-to-r from-[#F4C27F] to-[#D8605B] w-[315px] h-[56px] mx-auto rounded-full drop-shadow-3xl gap-x-2 hover:opacity-[0.7]'><p className='text-white'>Register</p> </button>
                    </div>
                </Form>
