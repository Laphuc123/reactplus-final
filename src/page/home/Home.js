...
import Arrow from "../../image/buttom/Vector.png";
        ...
        <>
            <div>
                ...
                <div className='pb-[56px]'>
                    <Link to="/registration"><button className='flex justify-center items-center bg-gradient-to-r from-[#F4C27F] to-[#D8605B] w-[315px] h-[56px] mx-auto rounded-full drop-shadow-3xl gap-x-2 hover:opacity-[0.7]'><p className='text-white'>Get Start</p><img src={Arrow} alt=""></img> </button></Link>
                </div>
            </div>
            <Outlet />
        </>
